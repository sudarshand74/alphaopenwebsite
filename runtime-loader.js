...
const adminModuleForPanel={players:"./player-admin.js?v=33","identity-audit":"./identity-reconciliation.js?v=10",rosters:"./roster-admin-v3.js?v=8",venues:"./venue-admin.js?v=26",seasons:"./season-bulk-import.js?v=9","season-teams":"./season-structure-admin.js?v=2","season-matchups":"./season-structure-admin.js?v=2","lineup-approvers":"./lineup-approver-admin.js?v=4"};
