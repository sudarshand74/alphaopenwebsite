...
assert(serviceWorker.includes("alphaopen-shell-v182"),"Missing versioned app-shell cache");
...
assert(html.includes('runtime-loader.js?v=43'),"Environment-aware runtime loader is missing");
