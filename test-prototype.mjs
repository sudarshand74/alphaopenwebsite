...
assert(html.includes('runtime-loader.js?v=61'),"Environment-aware runtime loader is missing");
...
assert(firebaseData.includes("getCountFromServer"), "Home Firebase loading must aggregate pending lineups without downloading matchup records");
assert(firebaseData.includes('if (route === "home")')&&firebaseData.includes("loadPendingApprovalCount(user),"), "Opening Home must refresh the operational approval count");
