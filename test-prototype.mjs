...
assert(html.includes('id="seasonRulesNotice" href="#rules"'),"Current-season rules link is missing");
...
assert(js.includes('`${seasonName} Matches by Round`'),"Matches by Round heading must use the active or selected season");
...
assert(js.includes('"UNAVAILABLE"')&&js.includes('classList.toggle("gray", !season)'),"Active Season must not show an ACTIVE badge when no season exists");
