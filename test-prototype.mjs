...
assert(html.includes('header-footer-consistency.css?v=6')&&serviceWorker.includes('/header-footer-consistency.css?v=6'),"Header and footer consistency styles must load online and offline");
